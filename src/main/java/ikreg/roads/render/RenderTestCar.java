...
public class RenderTestCar extends Render<EntityTestCar>
{
    ...
    protected ModelBase modelCar = new ModelTestCar();

    public RenderTestCar(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityTestCar entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    public void func_188311_a(EntityTestCar p_188311_1_, float p_188311_2_, float p_188311_3_)
    {
    ...
    public void renderMultipass(EntityTestCar p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_, float p_188300_8_, float p_188300_9_)
    {
        GlStateManager.pushMatrix();
        ...
        ((IMultipassModel)this.modelCar).renderMultipass(p_188300_1_, p_188300_9_, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GlStateManager.popMatrix();
    }
